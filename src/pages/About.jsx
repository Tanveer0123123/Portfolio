    ...
    <>
      ...
      <section className="bg-gradient-to-b from-gray-900 to-gray-950 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <p className="mt-4 text-gray-400">Home / About Me</p>
        </div>
      </section>
          ...
          >
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-bold text-white">
                Experience <span className="text-purple-400">Highlight</span>
              </h3>

              <p className="text-gray-300 mt-4 leading-relaxed max-w-4xl">
                Currently working as a{" "}
                <span className="text-purple-400 font-semibold">
                  Software Engineer Intern
                </span>{" "}
                where I contribute to ERP-level web applications, develop reusable components,
                integrate REST APIs, and optimize application performance using React and Next.js.
              </p>
